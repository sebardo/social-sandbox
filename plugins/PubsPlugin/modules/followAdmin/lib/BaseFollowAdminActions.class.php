<?php
require_once dirname(__FILE__).'/followAdminGeneratorConfiguration.class.php';
require_once dirname(__FILE__).'/followAdminGeneratorHelper.class.php';

/**
 * BaseFollowAdmin actions.
 *
 * @package    PubsPlugin
 * @subpackage followAdmin
 * @author     Dario Sebastian Sasturain <dsastu@gmail.com>
 * @version    SVN: $Id: actions.class.php 12474 2008-10-31 10:41:27Z fabien $
 */
class BaseFollowAdminActions extends autoFollowAdminActions
{
...
//        $this->setTemplate('new');
    ...
    protected function getPager() {
        $pager = $this->configuration->getPager('Follow');
    ...
    protected function setPage($page) {
        $this->getUser()->setAttribute('followAdmin.page', $page, 'admin_module');
    }

    protected function getPage() {
        return $this->getUser()->getAttribute('followAdmin.page', 1, 'admin_module');
    }
    ...
    protected function getSort() {
        if (null !== $sort = $this->getUser()->getAttribute('followAdmin.sort', null, 'admin_module')) {
            return $sort;
        }

        $this->setSort($this->configuration->getDefaultSort());

        return $this->getUser()->getAttribute('followAdmin.sort', null, 'admin_module');
    }
    ...
    protected function setSort(array $sort) {
        ...
        $this->getUser()->setAttribute('followAdmin.sort', $sort, 'admin_module');
    }

    protected function isValidSortColumn($column) {
        return Doctrine_Core::getTable('Follow')->hasColumn($column);
    }
