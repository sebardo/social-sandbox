        ...
        <div class="profile-actions">
            ...
            <?php } else { ?>
                <span class="thats-you">
                    <a href="<?php echo url_for('settings', array('config' => 'basicinfo')); ?>">Editar tu perfil&nbsp;→</a>
                </span>
            <?php } ?>
        </div>
...
<?php include_partial('follow/follow_tabs', array('action' => 'favlikes', 'datos' => $datos)) ?>
