...
class sfGuardRouting
{
  ...
  static public function addRouteForRegister(sfEvent $event)
  {
   ...
   static public function addRouteForValidation(sfEvent $event)
  {
    $event->getSubject()->prependRoute('sf_guard_register', new sfRoute('/guard/validation', array('module' => 'sfGuardRegister', 'action' => 'validation')));
  }
